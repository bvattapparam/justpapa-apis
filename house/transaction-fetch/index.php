...
function housePayment_byHouseId() {
  global $con;
  ...
  if($pagenation){
      $qry = "SELECT * FROM ng_house_payment WHERE HOUSEID = '$HOUSEID' ORDER BY MODIFIEDDATE DESC LIMIT $limit OFFSET $offset";
  } else {
      $qry = "SELECT * FROM ng_house_payment WHERE HOUSEID = '$HOUSEID' ORDER BY MODIFIEDDATE DESC";
    
  }
  $qry_res = mysqli_query($con,$qry);

  $qry_count = mysqli_query($con,"SELECT * FROM ng_house_payment");
